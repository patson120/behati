    ...
    <div>
      ...
      <section className="w-full mt-20 max-sm:-mt-12 mb-12">
        <div className="flex justify-center items-center">
          <div className="w-1/3 md:w-3/5 max-md:w-2/3 text-center max-sm:text-left max-sm:w-4/5 space-y-2">
        ...
        <div className="flex flex-row max-md:flex-col mt-4 gap-2 max-lg:border-2">
          <div className="h-auto w-1/2 max-md:w-full flex-shrink-0 relative">
            ...
            <div className="absolute w-1/2 max-md:w-3/4 translate-x-1/3 max-md:translate-x-20 max-sm:translate-x-5 max-lg:translate-x-5  bottom-12 z-30">
              ...
              <p className="text-md text-white max-sm:text-sm">L’huile de tournesol est une huile végétale riche en acides gras insaturés,
              ...
              <div className="mt-4 flex flex-row space-x-4 max-sm:space-x-2">
                <CustomButton
                  ...
                  containerStyle='yellow_color h-12 max-sm:h-10 max-sm:text-sm rounded-full text-md font-bold px-4'
                  handleClick={() => { }}
                />

                <CustomButton
                  title='En savoir plus'
                  containerStyle='border-2 border-white h-12 max-sm:h-10 max-sm:text-sm rounded-full text-white text-md font-bold px-4'
                  handleClick={() => { }}
                />
              </div>
            </div>
          ...
          <div className="h-auto w-1/2 max-md:w-full flex-shrink-0 relative">
            ...
            <div className="absolute w-1/2 max-md:w-3/4 translate-x-1/3 max-md:translate-x-20 max-sm:translate-x-5 max-lg:translate-x-5 bottom-12 z-30">
              ...
              <p className="text-md text-white max-sm:text-sm">La mayonnaise est une sauce onctueuse et savoureuse, à base d’huile de tournesol,
